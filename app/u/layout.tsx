...
const RewardsTab    = dynamic(() => import('./rewards/page'),      { ssr:false, loading:()=><TabSpinner/> })
...
const NAV_BASE = [
  ...
  { en:'Rewards',              ar:'مكافآت',            href:'/u/rewards',       icon:Key,          color:'#d99401', iconKey:'icon_loyalty'        },
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="flex items-center justify-between px-3 md:px-5 flex-shrink-0 relative z-10" style={{
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            {/* Logged-in: Search · Cart · Theme · Notifications · Logout (LTR visual left→right) */}
            {member && (
              <>
                {/* Search icon */}
